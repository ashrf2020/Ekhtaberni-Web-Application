...
class StudentRepository implements StudentRepositoryInterface{
    ...
    public function Update_Student($request)
    {
        try {
            ...
            $Edit_Students->class_id = $request->Classroom_id;
    ...
    public function Get_classrooms($id){
        ...
        $list_classes = Classe::where("grade_id", $id)->pluck("Name_Classe", "id");
        return $list_classes;
    ...
    public function Get_Sections($id){
        ...
        $list_sections = Section::where("classes_id", $id)->pluck("Name_Section", "id");
    ...
    public function Store_Student($request){
        ...
        try {
            ...
            $students->class_id = $request->Classroom_id;
