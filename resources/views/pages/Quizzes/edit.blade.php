...
@section('css')
@section('title')
    {{ trans('quizzes.edit_page_title') }} - {{ $quizz->getTranslation('name', app()->getLocale()) }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Quizzes.update','test')}}" method="post">
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ trans('quizzes.save_data') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
