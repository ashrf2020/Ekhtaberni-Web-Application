                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('quiz.last_question') }}</th>
                                            <th>{{ trans('quiz.score') }}</th>
                                            <th>{{ trans('quiz.manipulation') }}</th>
                                            <th>{{ trans('quiz.exam_date') }}</th>
                                            <th>{{ trans('quiz.operations') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($degrees as $degree)
                                            <tr>
                                                ...
                                                <td>{{$degree->score}}</td>
                                                @if($degree->abuse == 0)
                                                    <td style="color: green">{{ trans('quiz.no_manipulation') }}</td>
                                                @else
                                                    <td style="color: red">{{ trans('quiz.has_manipulation') }}</td>
                                                @endif
                                                <td>{{$degree->date}}</td>
                                                <td>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{ trans('quiz.allow_retake') }}</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit"
                                                                            class="btn btn-info">{{ trans('quiz.submit') }}</button>
                                                                    <p class="mt-3">{{ trans('quiz.confirm_retake') }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
