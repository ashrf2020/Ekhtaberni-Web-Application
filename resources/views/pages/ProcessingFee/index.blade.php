                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr class="alert-success">
                                            <th>#</th>
                                            <th>{{ trans('ProcessingFee.student_name') }}</th>
                                            <th>{{ trans('ProcessingFee.amount') }}</th>
                                            <th>{{ trans('ProcessingFee.description') }}</th>
                                            <th>{{ trans('ProcessingFee.actions') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
