                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ trans('questions.answers') }} <h6 style="color: red;"> *يجب فصل بعلامة - بين الاجابات</h6></label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="quizze_id">
                                                <option selected disabled placeholder="{{ trans('questions.select_quiz') }}"></option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="score">
                                                <option selected disabled placeholder="{{ trans('questions.select_score') }}"></option>
