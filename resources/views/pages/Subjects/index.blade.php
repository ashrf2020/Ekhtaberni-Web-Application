...
@section('css')
@section('title')
    {{ trans('subjects.list_page_title') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('subjects.subject_name_ar') }}</th>
                                        ...
                                        @foreach($subjects as $subject)
                                            ...
                                            <td>{{$subject->classroom->Name_Classe}}</td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('subjects.delete_confirm') }}</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p> {{ trans('subjects.delete_confirm') }} {{$subject->name}}</p>
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit"
                                                                        class="btn btn-danger">{{ trans('subjects.delete') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </form>
