                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($books as $book)
                                            <tr>
                                                ...
                                                <td>{{ $book->classroom->Name_Classe ?? '---' }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('library.edit',$book->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="{{ trans('library.edit') }}"><i class="fa fa-edit"></i></a>
