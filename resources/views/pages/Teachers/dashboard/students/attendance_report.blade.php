...
@section('title')
    {{trans('Students_trans.attendance_report')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('attendance.search') }}" autocomplete="off">
                    @csrf
                    <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{trans('Students_trans.search_info')}}</h6><br>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="card-body datepicker-form">
                            <div class="input-group" data-date-format="yyyy-mm-dd">
                                <input type="text"  class="form-control range-to date-picker-default" placeholder="{{trans('attendance.date')}}" required name="from">
                                <span class="input-group-addon">{{trans('attendance.to_date')}}</span>
                                <input class="form-control range-to date-picker-default" placeholder="{{trans('attendance.date')}}" type="text" required name="to">
                            </div>
                        </div>
                        ...
                        @foreach($Students as $student)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="btn-success">{{trans('attendance.presence')}}</span>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
