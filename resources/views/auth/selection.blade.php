...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="height-100vh d-flex align-items-center page-section-ptb login"
                    style="background-image: url('{{ asset('assets/images/index.png')}}');">
            <div class="container">
                <div class="text-center mb-4" style="float: right;position: absolute;top: 22px;right: 50px;">
                                <img src="{{ asset('assets/images/Logo.png') }}" alt="Logo" class="mx-auto" style="max-height: 100px;" />
                </div>
